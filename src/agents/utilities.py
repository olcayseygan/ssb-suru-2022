...
def necessary_obs(obs, team):
    ...
    new_obs = [*ally_unit_loc.tolist(), *enemy_unit_loc.tolist(), *
               ally_base_loc.tolist(), *enemy_base_loc.tolist(), *resource, *truck_load]
...
def multi_reward_shape(obs, team):  # Birden fazla truck için
    ...
    harvest_reward = load_reward + unload_reward + \
        enemy_load_reward + enemy_unload_reward
