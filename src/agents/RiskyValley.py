...
from utilities import (ally_locs, enemy_locs, getDistance, multi_forced_anchor,
                       multi_reward_shape)
...
class RiskyValley(BaseLearningAgentGym):
    ...
    def step(self, action):
        ...
        harvest_reward, enemy_count, ally_count = multi_reward_shape(
            self.nec_obs, self.team)
